        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="ltn__progress-bar-wrap">
                    <div class="section-title-area ltn__section-title-2">
                        ...
                        <h1 class="section-title">Đội ngũ chuyên môn hàng đầu<span>.</span></h1>
                        <p>Chúng tôi luôn trau dồi kỹ năng để mang đến chất lượng tốt nhất.</p>
                    </div>
            ...
            <div class="col-lg-6 align-self-center">
                <div class="about-img-right">
                    <img src="{{ asset('assets/clients/img/team/t-4.jpg')}}" alt="Hình ảnh">
                </div>
            </div>
        </div>
    </div>
