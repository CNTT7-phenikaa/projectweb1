        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title-area text-center">
                    ...
                    <p>Hãy tạo tài khoản của bạn để bắt đầu trải nghiệm mua sắm dễ dàng và nhanh chóng.</p>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="account-login-inner">
                    <form action="#" class="ltn__form-box contact-form-box" method="POST" id="register-form">
                        ...
                        <label class="checkbox-inline">
                            ...
                            Tôi đồng ý để Herboil xử lý dữ liệu cá nhân của tôi nhằm gửi các nội dung tiếp thị cá nhân hóa theo biểu mẫu đồng ý và chính sách quyền riêng tư.
                        </label>
                        @error('checkbox1')
                        <div class="alert alert-danger">{{ $message }}</div>
                        ...
                        <label class="checkbox-inline">
                            ...
                            Bằng cách nhấn "Tạo tài khoản", tôi đồng ý với chính sách quyền riêng tư.
                        </label>
